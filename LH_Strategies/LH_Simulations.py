...
parameter = 12.0 #Personal laptop - default instance
...
#sys.path.append("C:\\Users\\thoma\\OneDrive\\Desktop\\Revision1\\envs_continuous_space")  # folder containing ppo_modified.py
...
np.save("./RH_4_12_additional/opt_gap_"+str(parameter)+"_LP.npy", opt_gap_m)
np.save("./RH_4_12_additional/time_run_"+str(parameter)+"_LP.npy", time_run_m)
np.save("./RH_4_12_additional/obj_value_"+str(parameter)+"_LP.npy", obj_value_m)
np.save("./RH_4_12_additional/score_history_"+str(parameter)+"_LP.npy", Score_history)
