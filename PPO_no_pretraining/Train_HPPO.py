...
eval_callback = HEvalCallback(env1, env2, p_interval = p_interval, eval_freq=eval_timesteps,
                             log_path="./HPPO_evaluations_lr0.0001/instance_"+str(parameter)+"/",
...
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/scores_PPO.npy", scores)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/x_PPO.npy", x_m)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/y_PPO.npy", y_m)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/p_PPO.npy", p_m)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/d_PPO.npy", d_m)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/c_PPO.npy", c_m)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/lambda_PPO.npy", lambda_m)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/f_PPO.npy", f_m)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/w_PPO.npy", w_m)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/r_PPO.npy", r_m)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/z_PPO.npy", z_m)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/Revenue_PPO.npy", Revenue_v)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/LostSales_PPO.npy", LostSales_v)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/Repositioning_PPO.npy", Repositioning_v)
#np.save("./PPO_simulations_MC_lr0.0001/instance_"+str(parameter)+"/Profit_PPO.npy", Profit_v)