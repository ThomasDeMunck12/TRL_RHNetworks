...
train_size1 = int(0.8 * len(expert_dataset1))
test_size1 = len(expert_dataset1) - train_size1

train_size2 = int(0.8 * len(expert_dataset2))
...
base_folder = os.path.join(os.path.dirname(__file__), "..", "Experiments", f"instance_{parameter}")
os.makedirs(base_folder, exist_ok=True)

np.save(os.path.join(base_folder, "x_PPPO.npy"), x_m)
np.save(os.path.join(base_folder, "y_PPPO.npy"), y_m)
np.save(os.path.join(base_folder, "p_PPPO.npy"), p_m)
np.save(os.path.join(base_folder, "d_PPPO.npy"), d_m)
np.save(os.path.join(base_folder, "c_PPPO.npy"), c_m)
np.save(os.path.join(base_folder, "lambda_PPPO.npy"), lambda_m)
np.save(os.path.join(base_folder, "f_PPPO.npy"), f_m)
np.save(os.path.join(base_folder, "w_PPPO.npy"), w_m)
np.save(os.path.join(base_folder, "r_PPPO.npy"), r_m)
np.save(os.path.join(base_folder, "z_PPPO.npy"), z_m)
np.save(os.path.join(base_folder, "Revenue_PPPO.npy"), Revenue_v)
np.save(os.path.join(base_folder, "LostSales_PPPO.npy"), LostSales_v)
np.save(os.path.join(base_folder, "Repositioning_PPPO.npy"), Repositioning_v)
np.save(os.path.join(base_folder, "Profit_PPPO.npy"), Profit_v)